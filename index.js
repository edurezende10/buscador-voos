...
// Carrega permissões do JSON (Estratégia de Espelho)
let GRUPOS = {};
try {
...
// ==================================================================
// 6. MONITORAMENTO (PRODUÇÃO / HEADLESS)
// ==================================================================
async function monitorarViagens() {
    ...
    const browser = await puppeteer.launch({ 
        ...
        // No Koyeb/Docker vai usar o path do sistema. No Windows local vai usar o padrão.
